    ...
    public function rules()
    {
        ...
        return array_merge(
            ...
            array(
                ...
                array('paypal_acc', 'email', 'on' => 'paypal_acc'),
                array('scrill_acc', 'email', 'on' => 'scrill_acc'),
                ...
                array('webmoney_acc, scrill_acc, paypal_acc, account_number', 'length', 'max' => 140),
                array('account_holder', 'length', 'max' => 140),
//                array('account_number', 'length', 'max' => 25),
                array('bic', 'length', 'max' => 12),
