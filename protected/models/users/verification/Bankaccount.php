 ...
 */
class Users_Verification_Bankaccount extends ActiveRecord
{
	/**
	...
	{
		return 'users_verification_bankaccount';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			/*array('account_number', 'length', 'min' => 5, 'max'=>255, 'message' => Yii::t('Front', 'card id not valid')),*/
