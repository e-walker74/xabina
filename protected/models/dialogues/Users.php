...
/**
 * This is the model class for table "dialogues_users".
 *
 * The followings are the available columns in table 'dialogues_users':
 * @property integer $id
 ...
 * @property Users $user
 */
class Dialogues_Users extends CActiveRecord
{
	/**
	 ...
	 * @return DialoguesUsers the static model class
	 */
