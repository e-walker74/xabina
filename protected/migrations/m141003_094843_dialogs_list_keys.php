...
class m141003_094843_dialogs_list_keys extends CDbMigration
{
	public function up()
	{
		$this->execute('
		...
		--
		-- Constraints for table `dialogs_list`
		--
		ALTER TABLE `dialogs_list`
		  ADD CONSTRAINT `dialogs_list_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);		
		');	
	}

	public function down()
	{
		echo "m141003_094843_dialogs_list_keys does not support migration down.\n";
		return false;
	}
