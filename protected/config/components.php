...
return array(
    ...
    'urlManager' => array(
        ...
        'rules' => array(
			...
			'/banking/accounts/transaction/<id:\d+>' => '/accounts/transaction',
			'/banking/accounts/transaction/<id:\d+>/<exportType:(pdf|csv|doc)>' => '/accounts/transaction',
			...
			'/banking/accounts/transaction/ondoc' => 'accounts/transactionsondoc',
			'/banking/accounts/transaction/oncsv' => 'accounts/transactionsoncsv',
