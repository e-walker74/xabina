<?php
class ContactValidator extends CValidator{
	/**
	...
	{
		if($object->{$attribute}){
            if(!Users_Contacts::model()->currentUser()->findByPk($object->{$attribute})) {
				$this->addError($object, $attribute, Yii::t('Front', 'Contact is incorrect'));
            }
        }
	}
