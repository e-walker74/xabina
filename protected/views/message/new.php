    ...
    <div class="reply-container">
        <div class="message-headers">
            <div class="message-controls">
                <?php echo CHtml::link(Yii::t('Front', 'Send message'), "#", array(
                       'submit' => array('/message/save/send/'.$model->id),
                       'csrf' => true,
                       'class' => 'button-violet'
                   )
                ); ?>
                <a class="button-violet" href="#" id="attachment_add"><?= Yii::t('Front', 'Add attachment'); ?></a>

                <?php echo CHtml::link(Yii::t('Front', 'Save message'), "#", array(
                ...
                <a class="button-violet" href="<?= Yii::app()->createUrl('/message/cancel/'.$model->id)?>" id="attachment_add"><?= Yii::t('Front', 'Cancel'); ?></a>
            </div>
                            ...
                            <div class="td-cont ">
                                <div class="field-row">
                                    ...
                                    <div class="file-row">
                                        ...
                                        <span class="file-name"><?= Yii::t('Front', 'Skan passport 1'); ?></span>
                                ...
                                <div class="field-row">
                                    <div
                                        class="violet-button-slim"><?= Yii::t('Front', 'Upload selected files'); ?></div>
                                </div>
                            </div>
                        </td>
                        <td width="12%"></td>
