<div class="popup-register-cont">
    <div class="popup-register-block success">
        ...
        <div class="congratulations-msg">
            ...
            <a class="send-again" onclick="resendLoginEmail('<?= Yii::t('Front', 'E-mail was sent') ?>', '<?= Yii::app()->createUrl('/site/resendBlockEmail') ?>')" href="javaScript:void(0)"><?= Yii::t('Front', 'Send E-mail again.') ?></a>
