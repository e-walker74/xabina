...
<?php endif; ?>
	...
	<table class=" xabina-table-choose">
		<tbody>
		<tr class="tr-header">
			<td><?= Yii::t('Front', 'Add Paypal account') ?></td>
		</tr>
		<tr class="list-tr">
			<td>
				<table class="verification-code-table">
					<tbody><tr>
						<td width="20%"><?= $model->getAttributeLabel('email') ?>:</td>
						<td width="80%" class="header"><?= $model->email ?></td>
					</tr>
				</tbody></table>
			</td>
		</tr>
	...
	<div class="form-submit">
		<a href="<?= Yii::app()->createUrl('/verification/verificatinmethod', array('modelId' => 'paypal', 'back' => 1)); ?>" class="submit-button button-back"><?= Yii::t('Front', 'Back'); ?></a>
