<table class="inner-totals-table">
	<tbody>
		...
		<tr class="footer-tr form-submit">
			<td colspan="4">
				<a onclick="js:checkAll(this);" href="<?= Yii::app()->createUrl('/transfers/smsconfirm') ?>" class="submit-button button-next"><?= Yii::t('Front', 'select all and send') ?></a>
				<a class="submit-button button-back selected" onclick="return checkSelectedTransactions('<?= Yii::t('Front', 'You not selected any transactions') ?>');" href="<?= Yii::app()->createUrl('/transfers/smsconfirm') ?>"><?= Yii::t('Front', 'send selected tasks') ?></a>
			</td>
		</tr>
