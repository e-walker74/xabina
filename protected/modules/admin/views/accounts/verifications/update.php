<div id="wrap">
	<div id="page-heading">
		<h1><?= Yii::t('Users', 'Verification User: <b>' . $model->user->login . '</b>') ?></h1>
	</div>
		...
		<div class="panel panel-midnightblue">
			...
			<div class="panel-body collapse in">
				...
				<div class="form-group">
					<?php echo $form->labelEx($model->user, 'first_name', array('class' => 'col-sm-3 control-label')); ?>
					<div class="col-sm-6">
						<?php echo $form->textField($model->user, 'first_name', array('disabled' => 'disabled', 'size' => 60, 'maxlength' => 255, 'class' => 'form-control')); ?>
					</div>
				</div>
				
				<div class="form-group">
					<?php echo $form->labelEx($model->user, 'last_name', array('class' => 'col-sm-3 control-label')); ?>
					<div class="col-sm-6">
						<?php echo $form->textField($model->user, 'last_name', array('disabled' => 'disabled', 'size' => 60, 'maxlength' => 255, 'class' => 'form-control')); ?>
					</div>
				</div>
				
				<?php foreach($files as $file): ?>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="Users_Files_user_file_name"><?= $file->getAttributeLabel('user_file_name') ?></label>
						<div class="col-sm-6">
				...
				<?php if($model->notary): ?>
					<div class="form-group">
						<?php echo $form->labelEx($model, 'moderator_description', array('class' => 'col-sm-3 control-label')); ?>
						<div class="col-sm-6">
							<?= $form->textarea($model, 'moderator_description', array('cols' => 40, 'rows' => 4, 'class' => 'form-control')) ?>
						</div>
					</div>
				<?php endif; ?>
