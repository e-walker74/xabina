...
<div class="method-1 electronic-method-fields">
    <div class="form-line">
        <div class="form-cell">
            ...
            <div class="field-input">
                <?= $form->textField($model, 'creditcard_holder', array('class' => 'input-text', 'style' => 'width:100%')) ?>
    ...
    <div class="form-cell pull-left credit-number" style="width: 42%">
        ...
        <div class="field-input">
            <?= $form->textField($model, 'creditcard_number', array('class' => 'input-text')) ?>
        ...
        <div class="form-cell" >
            ...
            <div class="field-input">
                <ul class="list-inline payments-list">
                    <li>
                        <label>
                            <input type="radio" name="<?=$modelName?>[card_type]" class="master-card" value="<?= array_search('master-card', Transfers_Incoming::$card_types) ?>">
                    ...
                    <li>
                        <label>
                            <input type="radio" name="<?=$modelName?>[card_type]" class="jcb" value="<?= array_search('jcb', Transfers_Incoming::$card_types) ?>">
                            <div class="logo jcb ">
                            </div>
                        </label>
                    </li>
                    <li>
                        <label>
                            <input type="radio" name="<?=$modelName?>[card_type]" class="union-pay" value="<?= array_search('union-pay', Transfers_Incoming::$card_types) ?>">
                    ...
                    <li>
                        <label>
                            <input type="radio" name="<?=$modelName?>[card_type]" class="maestro" value="<?= array_search('maestro', Transfers_Incoming::$card_types) ?>">
                    ...
                    <li>
                        <label>
                            <input type="radio" name="<?=$modelName?>[card_type]" class="visa" value="<?= array_search('visa', Transfers_Incoming::$card_types) ?>">
                            <div class="logo visa ">
                            </div>
                        </label>
                    </li>
                    <li>
                        <label>
                            <input type="radio" name="<?=$modelName?>[card_type]" class="american-ecspress" value="<?= array_search('american-ecspress', Transfers_Incoming::$card_types) ?>">
