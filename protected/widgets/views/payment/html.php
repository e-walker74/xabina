        ...
        <div class="form-cell">
            ...
            <div class="field-input">
                <ul class="list-inline payments-list">
                    <li>
                        <label>
                            <input type="radio" name="<?= $this->modelName ?>[card_type]" class="master-card"
                    ...
                    <li>
                        <label>
                            <input type="radio" name="<?= $this->modelName ?>[card_type]" class="jcb"
                    ...
                    <li>
                        <label>
                            <input type="radio" name="<?= $this->modelName ?>[card_type]" class="union-pay"
                    ...
                    <li>
                        <label>
                            <input type="radio" name="<?= $this->modelName ?>[card_type]" class="maestro"
                    ...
                    <li>
                        <label>
                            <input type="radio" name="<?= $this->modelName ?>[card_type]" class="visa"
                    ...
                    <li>
                        <label>
                            <input type="radio" name="<?= $this->modelName ?>[card_type]" class="american-ecspress"
