...
$.grep(this.getTokens(),function(token){return token.value===value}).length){var duplicateEvent=$.Event("preventDuplicateToken");duplicateEvent.token={value:value,label:label};this.$element.trigger(duplicateEvent);var duplicate=this.$wrapper.find('.token[data-value="'+value+'"]').addClass("duplicate");setTimeout(function(){duplicate.removeClass("duplicate")},250);return false}var token=$('<div class="token" />').attr("data-value",value).append('<span class="token-label" />').append('<a href="#" class="close" tabindex="-1"></a>');
