...
(function($) {
	...
	var do_when_ready = function(){
		body = $(".top-bar .container .clearfix");
		jwindow = $(window);
		...
		pnotify: function(options) {
			...
			pnotify.pnotify_position = function(dont_skip_hidden){
				...
				if (!hidden || dont_skip_hidden) {
					...
					if ((s.dir1 == "down" && s.nextpos1 + pnotify.height() > jwindow.height()) ||
						...
						s.nextpos1 = s.firstpos1;
						s.nextpos2 += s.addpos2 + (typeof s.spacing2 == "undefined" ? 0 : s.spacing2);
						s.addpos2 = 0;
					}
					...
					switch (s.dir1) {
						...
						case "left":
						case "right":
							s.nextpos1 += pnotify.width() + (typeof s.spacing1 == "undefined" ? 15 : s.spacing1);
							break;
					}
				}
			};
			...
			pnotify.pnotify_display = function() {
				...
				if (!pnotify.parent().length)
					pnotify.appendTo(this.opts.stack.context);
				// Run callback.
				if (opts.before_open) {
			...
			.append($("<span>x</span>", {"class": styles.closer}))
			...
			if (opts.history) {
				...
				if (typeof history_menu == "undefined") {
					...
					.appendTo(this.opts.stack.context);
	...
	$.pnotify.defaults = {
		...
		stack: {"dir1": "down", "dir2": "left", "push": "bottom", "spacing1": 15, "spacing2": 15, "context": $('body')}
	};
})(jQuery);